...
package com.dmhsh.samples.apps.nowinandroid.feature.alarm.navigation
...
object AlarmDestination : NiaNavigationDestination {
...
fun NavGraphBuilder.topicGraph(
    ...
    composable(
        route = AlarmDestination.route,
        arguments = listOf(
            navArgument(AlarmDestination.topicIdArg) {
                type = NavType.StringType
            }
        )
    ) {
        AlarmRoute(onBackClick = onBackClick)
    }
}
