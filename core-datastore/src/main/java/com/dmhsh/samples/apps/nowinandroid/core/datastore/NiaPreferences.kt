...
import com.dmhsh.samples.apps.nowinandroid.core.datastore.UserPreferences
import com.dmhsh.samples.apps.nowinandroid.core.datastore.copy
...
class NiaPreferences @Inject constructor(private val userPreferences: DataStore<UserPreferences>) {
