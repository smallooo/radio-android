...
import com.dmhsh.samples.apps.nowinandroid.core.ui.theme.borderlessTextFieldColors
...
fun SearchTextField(
    ...
    hint: String = stringResource(R.string.app_id),
    maxLength: Int = 200,
            ...
            AnimatedVisibility(
                ...
                IconButton(
                    ...
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.app_id)
                    )
                }
            }
        },
